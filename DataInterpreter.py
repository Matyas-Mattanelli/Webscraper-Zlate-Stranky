...
class DataInterpreter:
    ...
    dataset_raw : pandas.DataFrame
        A raw data set generated by the DatasetCompiler
    ...
    array_of_sums_of_opening_hours_spans : numpy.array
    ...
    removeEmptyObservations(dataset):
        A function to remove observations which contain insufficient information
    ...
    getArrayOfSumsOfOpeningHoursSpans(dataset):
        A function to sum the opening hours duration for each restaurant and put it in a numpy array
